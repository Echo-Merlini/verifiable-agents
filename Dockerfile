...
# AgentMarketEscrow (mainnet) — buy/sell agents on /marketplace + admin controls.
ARG NEXT_PUBLIC_AGENT_MARKET_ESCROW=
ENV NEXT_PUBLIC_AGENT_MARKET_ESCROW=$NEXT_PUBLIC_AGENT_MARKET_ESCROW
ARG NEXT_PUBLIC_AGENT_MARKET_FROM_BLOCK=0
ENV NEXT_PUBLIC_AGENT_MARKET_FROM_BLOCK=$NEXT_PUBLIC_AGENT_MARKET_FROM_BLOCK
