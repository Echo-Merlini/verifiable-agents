          ...
          <div className="flex items-center gap-4">
            ...
            {!address ? (
              ...
              <div className="flex items-center gap-3">
                ...
                <button onClick={() => disconnect()} title="Disconnect" className="inline-flex items-center gap-1.5 font-mono text-[11px] uppercase tracking-[0.2em] text-gb-muted hover:text-red-400 transition-colors">
