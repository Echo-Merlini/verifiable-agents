    ...
    <main className="min-h-screen bg-deepink text-paper">
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-8 rounded-2xl border border-brassLight/25 bg-brassLight/[0.03] p-4">
          ...
          <p className="mt-1.5 text-[12px] leading-relaxed text-gb-muted">
            In 2026, cryptanalysis from <a href="https://www.anthropic.com/research/discovering-cryptographic-weaknesses" target="_blank" rel="noreferrer" className="text-brassLight hover:text-brass">Anthropic</a> cut <span className="text-paper/70">HAWK-256</span>&apos;s estimated key-recovery cost from <span className="text-paper/70">2<sup>64</sup> → 2<sup>38</sup></span>, and its submission team withdrew HAWK from NIST&apos;s additional-signatures process. But the result is <span className="text-paper/70">structural, not general</span>: HAWK is a Falcon-lineage hash-and-sign scheme on the Lattice Isomorphism Problem — a different problem <em>and</em> construction from ML-DSA (Fiat-Shamir over MLWE/MSIS), so it doesn&apos;t reach the finalized standards. HAWK was a candidate, deployed nowhere; the finalized FIPS — <span className="text-paper/70">ML-KEM, ML-DSA, SLH-DSA</span> — are untouched (withdrawal stated on NIST&apos;s round-3 additional-signatures page). The lesson isn&apos;t &ldquo;lattices are broken&rdquo;; it&apos;s that <span className="text-paper/70">candidates fall and finalized standards hold</span> — a break that depends on lattice structure doesn&apos;t transfer to the hash-based lane.
          </p>
