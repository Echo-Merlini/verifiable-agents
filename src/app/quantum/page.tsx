    ...
    <main className="min-h-screen bg-deepink text-paper">
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-8 rounded-2xl border border-brassLight/25 bg-brassLight/[0.03] p-4">
          ...
          <p className="mt-1.5 text-[12px] leading-relaxed text-gb-muted">
            In 2026, AI-assisted cryptanalysis cut <span className="text-paper/70">HAWK-256</span>&apos;s estimated key-recovery cost from <span className="text-paper/70">2<sup>64</sup> to 2<sup>38</sup></span> — after <span className="text-paper/70">HAWK</span>, a lattice-based NIST post-quantum <span className="text-paper/70">candidate</span>, had survived two rounds of expert review over roughly two years; its authors withdrew it from NIST&apos;s process after coordinated public disclosure (<a href="https://www.anthropic.com/research/discovering-cryptographic-weaknesses" target="_blank" rel="noreferrer" className="text-brassLight hover:text-brass">Anthropic research</a>). Scope matters: HAWK was a candidate, deployed nowhere, and the result does <span className="text-paper/70">not generalize</span> to other post-quantum schemes or to lattice cryptography as a whole — the finalized standards (ML-DSA, ML-KEM) came through untouched. The lesson isn&apos;t &ldquo;lattices are broken&rdquo;; it&apos;s that <span className="text-paper/70">candidates fall and finalized standards hold</span>.
          </p>
