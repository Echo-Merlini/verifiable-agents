    ...
    <main className="min-h-screen bg-deepink text-paper">
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        ...
        <div className="mt-8 rounded-2xl border border-brassLight/25 bg-brassLight/[0.03] p-4">
          ...
          <p className="mt-1.5 text-[12px] leading-relaxed text-gb-muted">
            In July 2026, AI-assisted cryptanalysis found a τ-cocycle automorphism in <span className="text-paper/70">HAWK</span> — a lattice-based NIST post-quantum <span className="text-paper/70">candidate</span> — cutting its HAWK-256 key-recovery work factor from <span className="text-paper/70">2<sup>64</sup> to 2<sup>38</sup></span>, a symmetry two years of human review had missed. HAWK was <span className="text-paper/70">withdrawn from NIST&apos;s process</span>; it was deployed nowhere. The lesson isn&apos;t &ldquo;lattices are broken&rdquo; — it&apos;s that <span className="text-paper/70">candidates fall and finalized standards hold</span>: the finalized standards (ML-DSA, ML-KEM) came through untouched.
          </p>
